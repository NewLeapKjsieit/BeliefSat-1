...
static uint8_t CODEWORD[CODEWORD_SIZE_BYTES] = {
	0xff, 0x8c, 0x79, 0x5a, 0x86, 0x69, 0x42, 0xaf,
	0xe8, 0x62, 0x77, 0xf0, 0xac, 0x7a, 0x10, 0x3,
	0x89, 0x4e, 0xb7, 0x2, 0x71, 0x56, 0xa3, 0xb7,
	0x23, 0x4d, 0x98, 0x5e, 0xd, 0x61, 0xa, 0x3c};
...
void ccsds_scrambler(uint8_t *data, size_t len)
{
	int cnt = 0;
	while (cnt < len * 8)
	{
...
void ccsds_descrambler(uint8_t *data, size_t len)
{
	int cnt = 0;
	while (cnt < len * 8)
	{
